import { j as jsxRuntimeExports, F as Field, L as Label, S as Span, H as Hint, I as Input$1, M as Message, r as reactExports, u as useToast, a as useTranslation, N as Notification, T as Title, C as Close, s as styled, b as Textarea, c as Field$1, d as Label$1, e as Hint$1, f as Combobox, O as Option, g as Message$1, h as Checkbox$1, i as OptGroup, D as DOMPurify, k as FileList, l as File, m as Tooltip, P as Progress, A as Anchor, n as mime, o as useDropzone, p as FileUpload, q as Datepicker, t as useGrid, v as focusStyles, w as FauxInput, x as Tag, y as SvgAlertWarningStroke, z as MediaInput, B as SvgCreditCardStroke, W as We, E as getColorV8, G as Header, J as SvgCheckCircleStroke, K as useModalContainer, Q as Modal, R as Body, U as Accordion, V as Paragraph, X as Footer$1, Y as FooterItem, Z as Button, _ as Close$1, $ as addFlashNotification, a0 as Alert, a1 as initI18next, a2 as loadTranslations, a3 as reactDomExports, a4 as ThemeProviders, a5 as createTheme } from 'shared';
...
function Input({
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [jsxRuntimeExports.jsxs(Label, {
      children: [label, required && jsxRuntimeExports.jsx(Span, {
        "aria-hidden": "true",
        children: "*"
      })]
    }), description && jsxRuntimeExports.jsx(Hint, {
      ...
      ...stepProp
    }), error && jsxRuntimeExports.jsx(Message, {
      validation: "error",
      children: error
    })]
  });
...
function useWysiwyg({
  ...
  return reactExports.useCallback(async ref => {
    if (hasWysiwyg && ref && !isInitializedRef.current) {
      ...
      const {
        createEditor
      } = await import('@zendesk/help-center-wysiwyg');
      ...
      notifications.on("show", (event, data) => {
        ...
        addToast(({
          ...
          children: [jsxRuntimeExports.jsx(Title, {
            children: title
          }), message, jsxRuntimeExports.jsx(Close, {
...
function TextArea({
  ...
  return jsxRuntimeExports.jsxs(StyledField, {
    children: [jsxRuntimeExports.jsxs(Label, {
      ...
      rows: 6,
      isResizable: true
    }), error && jsxRuntimeExports.jsx(StyledMessage, {
      validation: "error",
      children: error
    })]
  });
...
function EmptyValueOption() {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx(Span, {
      ...
      hidden: true,
      children: t("new-request-form.dropdown.empty-option", "Select an option")
    })]
  });
}
...
function DropDown({
  ...
  return jsxRuntimeExports.jsxs(Field$1, {
    children: [jsxRuntimeExports.jsxs(Label$1, {
      children: [label, required && jsxRuntimeExports.jsx(Span, {
        "aria-hidden": "true",
        children: "*"
      })]
    }), description && jsxRuntimeExports.jsx(Hint$1, {
      dangerouslySetInnerHTML: {
        __html: description
      }
      ...
      children: [!required && jsxRuntimeExports.jsx(Option, {
        value: "",
        label: "-",
    ...
    }), error && jsxRuntimeExports.jsx(Message$1, {
      validation: "error",
      children: error
    })]
  });
    ...
    if (!name.includes("::")) {
      ...
      for (let i = 0; i < groupNames.length; i++) {
        ...
        if (!result[parentGroupIdentifier]) {
          result[parentGroupIdentifier] = buildSubGroupOptions(parentGroupNames);
        }
...
function getInitialGroup(nestedOptions) {
  ...
  Object.values(nestedOptions).forEach(({
    options
  }) => {
    result.options.push(...options.filter(({
      type
    }) => type === undefined));
  });
  return result;
}
function useNestedOptions({
  options,
  hasEmptyOption
}) {
...
function MultiSelect({
  ...
  return jsxRuntimeExports.jsxs(Field$1, {
    children: [selectedValues.map(selectedValue => jsxRuntimeExports.jsx("input", {
      type: "hidden",
      name: `${name}[]`,
      value: selectedValue
    }, selectedValue)), jsxRuntimeExports.jsxs(Label$1, {
      children: [label, required && jsxRuntimeExports.jsx(Span, {
        "aria-hidden": "true",
        children: "*"
      })]
      ...
      maxHeight: "auto",
      children: [currentGroup.type === "SubGroup" && jsxRuntimeExports.jsx(Option, {
        ...currentGroup.backOption
      }), currentGroup.type === "SubGroup" ? jsxRuntimeExports.jsx(OptGroup, {
        "aria-label": currentGroup.name,
        children: currentGroup.options.map(option => jsxRuntimeExports.jsx(Option, {
          ...option,
          children: option.menuLabel ?? option.label
        }, option.value))
      }) : currentGroup.options.map(option => jsxRuntimeExports.jsx(Option, {
        ...option
      }, option.value))]
    }), error && jsxRuntimeExports.jsx(Message$1, {
      validation: "error",
...
function TicketFormField({
  ...
  const ref = /*#__PURE__*/reactExports.createRef();
  const handleChange = ({
    selectionValue
  }) => {
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [jsxRuntimeExports.jsx("input", {
      ...
      name: field.name,
      value: field.value
    }), field.options.length > 1 && jsxRuntimeExports.jsxs(Field$1, {
      children: [jsxRuntimeExports.jsx(Label$1, {
        children: field.label
      }), jsxRuntimeExports.jsx(Combobox, {
        isEditable: false,
        onChange: handleChange,
        ref: ref,
        children: field.options.map(option => jsxRuntimeExports.jsx(Option, {
          value: option.value,
          label: option.name,
      ...
      ref.submit = async () => {
        ...
        if (isSubmitting.current === false) {
          ...
          for (const creditCardField of creditCardFields) {
            ...
            if (creditCardInput && creditCardInput instanceof HTMLInputElement && creditCardInput.value.length === 4) {
...
const ALLOWED_HTML_TAGS = ["pre", "strong", "b", "p", "blockquote", "ul", "ol", "li", "h2", "h3", "h4", "i", "em", "br"];
  ...
  for (const [key, value] of params) {
    ...
    switch (field.type) {
      case "partialcreditcard":
        continue;
      case "multiselect":
        field.value = sanitizedValue.split(",")
      ...
      case "checkbox":
        if (ALLOWED_BOOLEAN_VALUES.includes(sanitizedValue)) {
          field.value = sanitizedValue === "true" ? "on" : sanitizedValue === "false" ? "off" : "";
        }
        break;
      default:
...
function FileListItem({
  ...
  const handleCloseKeyDown = e => {
    if (e.code === "Enter" || e.code === "Space" || e.code === "Delete" || e.code === "Backspace") {
      e.preventDefault();
      onRemove();
    }
  };
  ...
  return jsxRuntimeExports.jsx(FileList.Item, {
    children: jsxRuntimeExports.jsx(File, {
      ...
      children: file.status === "pending" ? jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
        children: [jsxRuntimeExports.jsx(FileNameWrapper, {
          children: fileName
          ...
          value: file.progress,
          "aria-label": t("new-request-form.attachments.uploading", "Uploading {{fileName}}", {
            fileName
          })
        })]
...
function Attachments({
  ...
  const {
    ...
    removePendingFile,
    removeUploadedFile
  } = useAttachedFiles(attachments.map(value => ({
    status: "uploaded",
    value
  })) ?? []);
  const {
  ...
  const notifyError = reactExports.useCallback(fileName => {
    addToast(({
      ...
      type: "error",
      children: [jsxRuntimeExports.jsx(Title, {
        children: t("new-request-form.attachments.upload-error-title", "Upload error")
      }), t("new-request-form.attachments.upload-error-description", "There was an error uploading {{fileName}}. Try again or upload another file.", {
        fileName
  ...
  }, [addPendingFile, removePendingFile, setPendingFileProgress, setUploaded, notifyError]);
  const {
    getRootProps,
    getInputProps,
    isDragActive
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [jsxRuntimeExports.jsx(Label, {
      ...
      children: [isDragActive ? jsxRuntimeExports.jsx("span", {
        children: t("new-request-form.attachments.drop-files-label", "Drop files here")
      }) : jsxRuntimeExports.jsx("span", {
        children: t("new-request-form.attachments.choose-file-label", "Choose a file or drag and drop here")
      }), jsxRuntimeExports.jsx(Input$1, {
        ...getInputProps()
      })]
    }), files.map(file => jsxRuntimeExports.jsx(FileListItem, {
      file: file,
      onRemove: () => {
        handleRemove(file);
      }
    }, file.status === "pending" ? file.id : file.value.id)), files.map(file => file.status === "uploaded" && jsxRuntimeExports.jsx("input", {
      type: "hidden",
      name: name,
...
function getAppliedConditions(fieldConditions, allConditions, fields) {
  return fieldConditions.filter(condition => {
    ...
    return parentField.value === condition.value && (parentFieldConditions.length === 0 || getAppliedConditions(parentFieldConditions, allConditions, fields).length > 0);
  });
}
...
function useTagsInputContainer({
  ...
  const handleInputKeyDown = e => {
    ...
    if (tag && (e.code === "Space" || e.code === "Enter" || e.code === "Comma" || e.code === "Tab")) {
      e.preventDefault();
      if (!hasTag(tag)) {
        addTag(tag);
      }
  ...
  const handleInputChange = e => {
    ...
    /* On mobile browsers, the keyDown event doesn't provide the code
      ...
      adds a tag  */
    const [tag, separator] = [currentValue.slice(0, -1), currentValue.slice(-1)];
...
function CcField({
  ...
  const initialValue = value ? value.split(",").map(email => email.trim()) : [];
  ...
  const {
    ...
    i18n: {
      ...
      removedTag: email => t("new-request-form.cc-field.email-removed", "{{email}} has been removed", {
        email
      }),
      addedTags: emails => t("new-request-form.cc-field.emails-added", "{{emails}} have been added", {
        emails
      })
    }
  });
  const renderTag = (index, isValid, email) => jsxRuntimeExports.jsxs(StyledTag, {
    size: "large",
    "aria-label": t("new-request-form.cc-field.email-label", "{{email}} - Press Backspace to remove", {
      email
    }),
    hue: isValid ? undefined : "red",
    children: [!isValid && jsxRuntimeExports.jsx(Tag.Avatar, {
      children: jsxRuntimeExports.jsx(SvgAlertWarningStroke, {})
    }), jsxRuntimeExports.jsx("span", {
      children: email
    }), jsxRuntimeExports.jsx(Tag.Close, {
      ...getTagCloseProps(index)
    })]
  });
  return jsxRuntimeExports.jsxs(Field, {
    children: [jsxRuntimeExports.jsx(Label, {
      ...
      ...getContainerProps(),
      children: [tags.length > 0 && jsxRuntimeExports.jsx("span", {
        ...getGridProps({
        ...
        children: jsxRuntimeExports.jsx("span", {
          ...
          children: tags.map((email, index) => {
            ...
            }, index) : jsxRuntimeExports.jsx(Tooltip, {
              content: t("new-request-form.cc-field.invalid-email", "Invalid email address"),
        ...
        children: [jsxRuntimeExports.jsx(InputMirror, {
          isBare: true,
          "aria-hidden": "true",
          tabIndex: -1,
          children: inputValue
      ...
      validation: "error",
      children: error
    }), tags.map(email => jsxRuntimeExports.jsx("input", {
      type: "hidden",
      name: name,
      value: email
    }, email)), jsxRuntimeExports.jsx(Span, {
      hidden: true,
      ...getAnnouncementProps(),
  ...
  return jsxRuntimeExports.jsxs(Field, {
    children: [jsxRuntimeExports.jsxs(Label, {
      children: [label, required && jsxRuntimeExports.jsx(Span, {
        ...
        children: t("new-request-form.credit-card-digits-hint", "(Last 4 digits)")
      })]
    }), description && jsxRuntimeExports.jsx(Hint, {
      dangerouslySetInnerHTML: {
        __html: description
...
function Tagger({
  ...
  return jsxRuntimeExports.jsxs(Field$1, {
    children: [jsxRuntimeExports.jsxs(Label$1, {
      ...
      }) : currentGroup.options.map(option => option.value === "" ? jsxRuntimeExports.jsx(Option, {
        ...option,
        children: jsxRuntimeExports.jsx(EmptyValueOption, {})
      }, option.value) : jsxRuntimeExports.jsx(Option, {
        ...option
      }, option.value))]
    }), error && jsxRuntimeExports.jsx(Message$1, {
      validation: "error",
...
function SuggestedArticles({
  ...
  return articles.length > 0 ? jsxRuntimeExports.jsx(Container, {
    "data-test-id": "suggested-articles",
    children: jsxRuntimeExports.jsxs(InnerContainer, {
      children: [jsxRuntimeExports.jsx("h2", {
        children: t("new-request-form.suggested-articles", "Suggested articles")
      }), jsxRuntimeExports.jsx(UnstyledList, {
        children: articles.map(article => jsxRuntimeExports.jsx(ListItem, {
          children: jsxRuntimeExports.jsx(Anchor, {
...
function AnswerBotModal({
  ...
  return jsxRuntimeExports.jsxs(Modal, {
    ...
    children: [jsxRuntimeExports.jsxs(StyledHeader, {
      tag: "h2",
      children: [jsxRuntimeExports.jsx(StyledSuccessIcon, {}), t("new-request-form.answer-bot-modal.request-submitted", "Your request was successfully submitted")]
    }), jsxRuntimeExports.jsxs(Body, {
      children: [jsxRuntimeExports.jsx(H3, {
        children: t("new-request-form.answer-bot-modal.title", "While you wait, do any of these articles answer your question?")
      }), jsxRuntimeExports.jsx("p", {
        children: t("new-request-form.answer-bot-modal.footer-content", "If it does, we can close your recent request {{requestId}}", {
          requestId: `\u202D#${requestId}\u202C`
        })
        ...
        children: articles.map(({
          ...
          snippet,
          title
        }) => jsxRuntimeExports.jsxs(Accordion.Section, {
          children: [jsxRuntimeExports.jsx(Accordion.Header, {
            ...
            children: [jsxRuntimeExports.jsx(Paragraph, {
              ...
              target: "_blank",
              children: t("new-request-form.answer-bot-modal.view-article", "View article")
            })]
          })]
        }, article_id))
      })]
    }), jsxRuntimeExports.jsxs(Footer$1, {
      children: [jsxRuntimeExports.jsx(FooterItem, {
        children: jsxRuntimeExports.jsx(Button, {
          onClick: () => {
            markArticleAsIrrelevant();
          },
          children: t("new-request-form.answer-bot-modal.mark-irrelevant", "No, I need help")
        })
        ...
        children: jsxRuntimeExports.jsx(Button, {
          ...
          children: t("new-request-form.answer-bot-modal.solve-request", "Yes, close my request")
        })
      })]
...
function NewRequestForm({
  ...
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [parentId && jsxRuntimeExports.jsx(StyledParagraph, {
      children: jsxRuntimeExports.jsx(Anchor, {
        href: parentIdPath,
        children: t("new-request-form.parent-request-link", "Follow-up to request {{parentId}}", {
          parentId: `\u202D#${parentId}\u202C`
        })
      })
    }), jsxRuntimeExports.jsx(StyledParagraph, {
      "aria-hidden": "true",
      children: t("new-request-form.required-fields-info", "Fields marked with an asterisk (*) are required.")
      ...
      children: [errors && jsxRuntimeExports.jsx(Alert, {
        type: "error",
        children: errors
      }), parent_id_field && jsxRuntimeExports.jsx(ParentTicketField, {
        field: parent_id_field
      }), ticket_form_field.options.length > 0 && jsxRuntimeExports.jsx(TicketFormField, {
        field: ticket_form_field,
        newRequestPath: newRequestPath
      }), emailField && jsxRuntimeExports.jsx(Input, {
        field: emailField
      }, emailField.name), ccField && jsxRuntimeExports.jsx(CcField, {
        field: ccField
      }), organizationField && jsxRuntimeExports.jsx(DropDown, {
        ...
        switch (field.type) {
          case "subject":
            return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              ...
              }, field.name), jsxRuntimeExports.jsx(SuggestedArticles, {
                query: field.value,
                locale: locale
              })]
            });
          ...
          case "description":
            return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [jsxRuntimeExports.jsx(TextArea, {
                ...
                brandId: brandId,
                onChange: value => handleChange(field, value)
              }, field.name), jsxRuntimeExports.jsx("input", {
                type: "hidden",
          ...
          case "tickettype":
            return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [jsxRuntimeExports.jsx(DropDown, {
                field: field,
                onChange: value => handleChange(field, value)
              }, field.name), field.value === "task" && jsxRuntimeExports.jsx(DatePicker, {
                field: dueDateField,
                locale: baseLocale,
          ...
          case "multiselect":
            return jsxRuntimeExports.jsx(MultiSelect, {
              field: field
            });
          case "tagger":
            return jsxRuntimeExports.jsx(Tagger, {
              field: field,
              onChange: value => handleChange(field, value)
            }, field.name);
          default:
      ...
      }), attachments_field && jsxRuntimeExports.jsx(Attachments, {
        field: attachments_field
      }), inline_attachments_fields.map(({
        type,
        name,
        value
      }, index) => jsxRuntimeExports.jsx("input", {
        type: type,
        name: name,
        value: value
      }, index)), jsxRuntimeExports.jsx(Footer, {
        children: (ticket_form_field.options.length === 0 || ticket_form_field.value) && jsxRuntimeExports.jsx(Button, {
          isPrimary: true,
          type: "submit",
          children: t("new-request-form.submit", "Submit")
        })
      })]
    }), answerBot.auth_token && answerBot.interaction_access_token && answerBot.articles.length > 0 && answerBot.request_id && jsxRuntimeExports.jsx(AnswerBotModal, {
...
async function renderNewRequestForm(settings, props, container) {
  ...
  reactDomExports.render(jsxRuntimeExports.jsx(ThemeProviders, {
    theme: createTheme(settings),
    children: jsxRuntimeExports.jsx(NewRequestForm, {
      ...props
    })
  }), container);
}
