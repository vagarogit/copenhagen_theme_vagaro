...
function loadAllArticles() {
  try {
    ...
    const accordionItems = document.querySelectorAll(".zd-custom-accordion__item");
    ...
    accordionItems.forEach(item => {
      ...
      loadingIndicator.style.cssText = "margin-top: 0.5rem; color: #6b7280; font-size: 0.875rem;";
